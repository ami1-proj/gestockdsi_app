    ...
    <div class="card m-b-30">
      <div class="card-body">
        <h4 class="mt-0 header-title">Modification Affectation {{ $elem_arr['type'] }}</h4>
          ...
          <p class="text-muted m-b-30 font-14">Modifer l affection <code class="highlighter-rouge"><strong>{{ $affectation->objet }}</strong></code>  assignee {{ $elem_arr['article'] }}  {{ $elem_arr['type'] }} <strong>{{ $elem_arr['elem']->designation_complete }}</strong>.</p>
