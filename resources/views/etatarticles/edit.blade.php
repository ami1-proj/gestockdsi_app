    ...
    <div class="card m-b-30">
      <div class="card-body">
        <h4 class="mt-0 header-title">Modification</h4>
          <p class="text-muted m-b-30 font-14">Modification de l’Etat de Commande <code class="highlighter-rouge">{{ $etatarticle->libelle }}</code>.</p>
          ...
          <form action="{{ route('etatarticles.update', ['etatarticle' => $etatarticle]) }}" method="POST">
            ...
            <div class="form-group row">
                <div>
                  ...
                  <a href="{{ route('parametres.index') }}" class="btn btn-secondary waves-effect m-l-5">Annuler</a>
                </div>
            </div>
