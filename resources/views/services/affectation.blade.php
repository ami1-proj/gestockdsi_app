...
@section('content')
    ...
    <form action="{{ route('services.affectationupdate', ['service' => $service]) }}" method="POST">
    @method('PUT')
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <p class="text-muted m-b-30 font-14">Gestion des articles du service <code class="highlighter-rouge" style=""><strong>{{ $service->intitule }}</strong></code>.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Articles du service</h4>
                        <div class="form-group">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <a href="{{ action('ServiceController@show', ['service' => $service->id]) }}" class="btn btn-secondary">Retour</a>
        </div>
    </div>
</form>
