...
trait PhonenumTrait {
     ...
     */
    public function createNew($numero, $elem_type, $elem_id) : Phonenum
    {
     ...
     */
    public function moveUp($phonenum_id, $elem_type, $elem_id) : Phonenum
    {
        $elem = $this->getElem($elem_type, $elem_id);
        ...
        if ($phonenum->pivot->rang > 1) {
            ...
            $this->switchRang($elem, ($phonenum->pivot->rang - 1), $phonenum->pivot->rang);
   ...
   * Deplace le numero de telephone d'un element (fournisseur, employe) vers le bas
     ...
     * @return Phonenum              Le numero de telephone modifie
     */
    public function moveDown($phonenum_id, $elem_type, $elem_id) : Phonenum
    {
        $elem = $this->getElem($elem_type, $elem_id);
        $phonenum = $elem->phonenums()->where('phonenum_id', $phonenum_id)->first();
   ...
   * Supprime le telephone d un element (fournisseur, employe)
     ...
     */
    public function deleteOne($phonenum_id, $elem_type, $elem_id) : int
    {
